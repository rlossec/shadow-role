...
Pour exécuter ces tests:
    uv run pytest tests/app/api/games/test_delete_game.py -v
"""
import pytest
...
from tests.app.api.games.helpers import get_game_url, get_delete_game_url


# 204 - Success (No Content)
@pytest.mark.asyncio
async def test_delete_game_success(client, auth_service, db_session):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_delete_game_unauthorized(client, auth_service, db_session):
