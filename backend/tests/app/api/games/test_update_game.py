...
from tests.app.api.games.helpers import get_base_game_update_payload, get_update_game_url


# 200 - Success
@pytest.mark.asyncio
async def test_update_game_success(client, auth_service, db_session):
...
@pytest.mark.asyncio
async def test_update_game_partial(client, auth_service, db_session):
...
@pytest.mark.asyncio
async def test_update_game_empty_payload(client, auth_service, db_session):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_update_game_unauthorized(client, auth_service, db_session):
