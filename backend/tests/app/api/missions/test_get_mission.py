...
Pour exécuter ces tests:
    uv run pytest tests/app/api/missions/test_get_mission.py -v
"""
import pytest
...
from tests.app.api.missions.helpers import get_mission_url


# 200 - Success
@pytest.mark.asyncio
async def test_get_mission_success(client, auth_service, db_session):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_get_mission_unauthorized(client, auth_service, db_session):
