...
Pour exécuter ces tests:
    uv run pytest tests/api/missions/test_create_mission.py -v
"""
import pytest
...
from tests.api.missions.helpers import get_base_mission_create_payload, get_create_mission_url
...
@pytest.mark.asyncio
async def test_create_mission_missing_required_field(client, auth_service, db_session, initialized_game_types, field):
