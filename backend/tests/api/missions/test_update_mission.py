...
from tests.api.missions.helpers import get_base_mission_update_payload, get_update_mission_url
...
@pytest.mark.asyncio
async def test_update_mission_partial(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_update_mission_empty_payload(client, auth_service, db_session, initialized_game_types):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_update_mission_unauthorized(client, auth_service, db_session, initialized_game_types):
