...
Pour exécuter ces tests:
    uv run pytest tests/api/missions/test_get_missions_by_game.py -v
"""
import pytest
...
from tests.api.missions.helpers import get_missions_by_game_url
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_get_missions_by_game_unauthorized(client, auth_service, db_session, initialized_game_types):
