...
from tests.api.lobbies.helpers import get_lobbies_url
...
@pytest.mark.asyncio
async def test_list_lobbies_with_pagination(client, auth_service, db_session, initialized_game_types):
