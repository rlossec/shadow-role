...
Pour exécuter ces tests:
    uv run pytest tests/api/lobbies/test_delete_lobby.py -v
"""
import pytest
...
from tests.api.lobbies.helpers import get_lobby_url, get_delete_lobby_url
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_delete_lobby_unauthorized(client, auth_service, db_session, initialized_game_types):
