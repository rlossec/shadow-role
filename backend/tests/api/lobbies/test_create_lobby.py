...
from tests.api.lobbies.helpers import get_base_lobby_create_payload, get_create_lobby_url
...
async def test_create_lobby_missing_required_fields(
    client, auth_service, db_session, initialized_game_types, missing_field
):
    """
...
@pytest.mark.asyncio
async def test_create_lobby_unauthorized(client, db_session, initialized_game_types):
