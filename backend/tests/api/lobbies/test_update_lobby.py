...
Pour exécuter ces tests:
    uv run pytest tests/api/lobbies/test_update_lobby.py -v
"""
import pytest
...
from tests.api.lobbies.helpers import get_base_lobby_update_payload, get_update_lobby_url


# 200 - Success
@pytest.mark.asyncio
async def test_update_lobby_success(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_update_lobby_partial_update(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_update_lobby_empty_payload(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_update_lobby_not_host(client, auth_service, db_session, initialized_game_types):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_update_lobby_unauthorized(client, auth_service, db_session, initialized_game_types):
