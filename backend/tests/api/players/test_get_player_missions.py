...
from repositories import GameRepository, LobbyRepository, PlayerRepository, MissionRepository
from tests.api.helpers import create_user_and_get_token, get_auth_headers
from tests.api.players.helpers import get_player_missions_url
...
@pytest.mark.asyncio
async def test_get_player_missions_by_host(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_get_player_missions_forbidden(client, auth_service, db_session, initialized_game_types):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_get_player_missions_unauthorized(client, auth_service, db_session, initialized_game_types):
