...
from tests.api.players.helpers import get_base_player_update_payload, get_update_player_url


# 200 - Success
@pytest.mark.asyncio
async def test_update_player_success(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_update_player_by_host(client, auth_service, db_session, initialized_game_types):
...
@pytest.mark.asyncio
async def test_update_player_forbidden(client, auth_service, db_session, initialized_game_types):
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_update_player_unauthorized(client, auth_service, db_session, initialized_game_types):
