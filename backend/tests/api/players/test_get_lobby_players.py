...
from tests.api.players.helpers import get_lobby_players_url
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_get_lobby_players_unauthorized(client, auth_service, db_session, initialized_game_types):
