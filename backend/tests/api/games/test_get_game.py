...
Pour exécuter ces tests:
    uv run pytest tests/api/games/test_get_game.py -v
"""
import pytest
...
from tests.api.games.helpers import get_game_url
...
# 401 - Unauthorized
@pytest.mark.asyncio
async def test_get_game_unauthorized(client, auth_service, db_session, initialized_game_types):
